...
<link rel="stylesheet" href="toast-master/css/toast.css">
<script src="toast-master/js/toast.js"></script>
<script src="toast-master/js/VUE.js"></script>
<style>
</style>
<body>
<div id="dafuq" class="toast_div" style="background-image: url(map.jpg); height: 1197px ;width: 1736px;border:1px solid black;position: relative ;float:left; display:inline;">
    ...
    <!--设置logo 包括透明度和位置 -->
    <img src="logo.jpg" style="height: 110px; width: 110px; margin-top: 720px; margin-left: 85px; filter:alpha(opacity=30);-moz-opacity:0.3;opacity:0.3; -khtml-opacity: 0.3;">
    ...
    <button class="button button-3d  button-square button-primary button-jumbo button-small" style="left:1340px;top:-200px; display:inline; width: 100px;" id="click_it">重新规划</button>

</div>

<script src="render_button.js"></script>
<script>
